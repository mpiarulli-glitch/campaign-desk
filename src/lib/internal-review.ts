...
export function internalReviewTodoMessageText(input: {
  ...
  return [
    ...
    "",
    "What I'm looking for in this pass:",
    "",
    "• Is this on brand?",
    "• Are the offers I've included appropriate?",
    "• Does this align with the overall strategy?",
    "",
    "How to review in the app:",
    "",
    "1. Open the internal review link below.",
    "2. Go through each item and leave comments on anything that needs a change.",
